#!/usr/bin/env python3
"""
Blog CSV Image Mapper
Maps all images from the CSV file to index.json with proper local paths.
"""
...
def map_csv_images():
    """Map all images from CSV to index.json."""
...
if __name__ == "__main__":
    ...
    print("Mapping images from CSV to index.json...")
    map_csv_images()
    print("Done!") 